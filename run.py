...
from creditentials import User, Credentials
    ...
    while True:
        ...
        if short_code == "cc":
            ...
            if find_credential(search_name):
                ...
                print("That Credential you want to delete does not exist  yet")
            ...
            print("Thanks for using passwords manager.. See you soon!")
            break
        else:
